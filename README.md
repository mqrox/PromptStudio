...
> 作りたいものを日本語で相談すると、足りない情報を確認しながら、生成AIで使えるプロンプトと設定に整理します。

PromptStudio は、生成AIのプロンプトを作り、保存し、チームで改善するためのツールです。

生成AIサービスが増えるほど、プロンプトやコツは個人に散らばります。PromptStudio は、それを会社で使える制作力として残せるようにします。

社員は、会社のルールや過去のノウハウを使いながら、画像生成・動画生成・広告制作などに使えるプロンプトを作れます。

保存するのは、プロンプトだけではありません。依頼内容、参照情報、入力素材、設定、結果、レビューまで残します。管理者はそれを見返して、共通スキルを改善できます。
...
良いプロンプトが個人のチャット履歴に残ったままだと、会社の資産になりません。

また、AIに渡す前提が人によって違えば、AIが作るプロンプトもバラつきます。

このままでは、生成AIに慣れている一部の人だけが速くなり、会社全体の制作力にはなりません。

---

## 2. 何が解決されるか

PromptStudio を使うと、プロンプト作成の前提を会社でそろえられます。

- 作りたいものを日本語で相談できる
- 足りない情報は確認しながら進められる
- 会社のルールや過去のノウハウを使える
- AIサービスごとのコツを共通スキルとして使える
- 作ったプロンプト、設定、結果を保存できる
- 管理者が見返して、共通スキルを改善できる

これにより、個人の勘や言語力だけに頼らず、チーム全体で生成AIを使いやすくなります。
