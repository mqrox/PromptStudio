...
生成AIプロンプトを考えるときに、最初に使う共通ワークベンチです。

ユーザーは「こういう絵を作りたい」「この商品を動画にしたい」「この案件のトーンで広告案を出したい」と日本語で相談します。

相談内容をもとに、目的、媒体、モデル、入力素材、案件ルール、社内ノウハウを整理し、実際に使えるプロンプトと生成設定へ変換します。
...
案件ごとに、制作フォルダ、前提資料、入力素材、成果物や副産物の保存先を設定します。

PromptStudio はその設定をもとに、参照すべき文脈と残すべき記録をそろえてからプロンプト作成を始めます。
