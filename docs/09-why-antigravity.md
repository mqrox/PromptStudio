...
ただし、PromptStudio全体をAntigravity専用に固定しない。Antigravity は有力な実行基盤であり、PromptStudio の本質である skill、knowledge、artifact、レビューPDCAは独立した資産として設計する。
...
Antigravityは初期の強い実行基盤。PromptStudioの本質は、前提条件を揃えるskill、knowledge、artifact、レビューPDCAである。
