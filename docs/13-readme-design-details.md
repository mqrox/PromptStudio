...
Antigravity は実行基盤候補であり、PromptStudio の本質である skill、knowledge、artifact、レビュー改善サイクルは独立した資産として設計する。
...
- [03-prompt-skill-improvement-loop.md](03-prompt-skill-improvement-loop.md): skill / knowledge / 保存物 / レビュー改善サイクル
